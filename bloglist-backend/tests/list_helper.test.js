...
describe('total likes', () => {
  ...
  test('when list has many blogs equals the sum of all their likes', () => {
    const result = listHelper.totalLikes(listWithMultipleBlogs)
    expect(result).toBe(36)
  })
  test('when list is empty equals to zero likes', () => {
...
describe('favourite blog', () => {
  test('when list has only one blog favourite blog is that', () => {
...
describe('most blogs', () => {
  test('when list has only one blog the author with most blogs is the author of that', () => {
...
describe('most likes', () => {
  test('when list has only one blog the author with most likes is the author of that', () => {
